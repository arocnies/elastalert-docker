...
if ! curl -XGET -k "https://${ELASTICSEARCH_HOST}:${ELASTICSEARCH_PORT}/elastalert_status" --cert /etc/elasticsearch/admin-cert --key /etc/elasticsearch/admin-key 2>/dev/null
then
